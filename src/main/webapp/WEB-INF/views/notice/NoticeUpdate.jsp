        ...
        <div class="col-sm-6 col-md-offset-3 " >
          <form>
                <div class=" text-center text-dark pt-5 " >
                    ...
                    <input type="text" class="form-control text-dark" id="u_subject" value="${result.NB_Subject }">
                
           
                    <h4 class="my-3">Content</h4>
                    <textarea rows="10" cols="20" class="form-control text-dark" id="u_content"  placeholder="">${result.NB_Content }</textarea>
